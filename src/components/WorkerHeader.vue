  ...
  <div>
      ...
      <el-col class="user-button">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <span v-show="admin">
              <router-link to="/admin-information" style="text-decoration:none;"> <el-dropdown-item>个人中心</el-dropdown-item></router-link> 
            </span >
            <router-link to="/homepage" style="text-decoration:none;"> <el-dropdown-item>退出</el-dropdown-item></router-link>
          </el-dropdown-menu>
        </el-dropdown>
      </el-col>
    </el-row>
    ...
    <el-row class="worker-nav">
      <el-col :span="7" :offset="2"> 
        ...
        <span v-show="admin">
           <router-link to="/admin-requester"><button class="nav-button">requester</button></router-link>
          <router-link to="/admin-work"><button class="nav-button">worker</button></router-link>
          <router-link to="/admin-application"><button class="nav-button">application</button></router-link>
        </span>
      </el-col>

      
      <el-col :span="7" class="input" :offset="2"> 
    ...
    if(path.indexOf("worker") != -1){
      ...
      this.admin = true;
       if(path == "/admin-request"){
        buttons[7].style.background = "#1471eb";
      }else if(path == "/admin-work"){
        buttons[8].style.background = "#1471eb";
      }else if(path == '/admin-application'){
        buttons[9].style.background = "#1471eb";
      }
    }
